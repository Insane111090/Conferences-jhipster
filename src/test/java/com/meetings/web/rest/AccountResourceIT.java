package com.meetings.web.rest;

import com.meetings.MeetingsApp;
import com.meetings.config.Constants;
import com.meetings.domain.User;
import com.meetings.repository.AuthorityRepository;
import com.meetings.repository.UserRepository;
import com.meetings.security.AuthoritiesConstants;
import com.meetings.service.UserService;
import com.meetings.service.dto.PasswordChangeDTO;
import com.meetings.service.dto.UserDTO;
import com.meetings.web.rest.vm.KeyAndPasswordVM;
import com.meetings.web.rest.vm.ManagedUserVM;
...
import static com.meetings.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
@SpringBootTest(classes = MeetingsApp.class)
